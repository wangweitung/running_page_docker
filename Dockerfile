...
RUN python3 run_page/gen_svg.py --from-db --title "my running page" --type grid --athlete "$YOUR_NAME" --output assets/grid.svg --min-distance 10.0 --special-color yellow --special-color2 red --special-distance 20 --special-distance2 40 --use-localtime \
  ...
  && python3 run_page/gen_svg.py --from-db --type monthoflife --birth "${birth}" --special-color "#f9d367" --special-color2 "#f0a1a8" --special-distance 10 --special-distance2 20  --output assets/mol.svg --use-localtime --athlete "$YOUR_NAME" --title 'Runner Month of Life' \
  && python3 run_page/gen_svg.py --from-db --type year_summary --output assets/year_summary.svg --athlete "$YOUR_NAME" \
  && python3 run_page/gen_svg.py --from-db --type monthoflife --birth "${birth}" --special-color "#f9d367"  --special-color2 "#f0a1a8" --output assets/mol_running.svg --use-localtime --athlete "$YOUR_NAME" --title "Runner Month of Life" --sport-type running  \
  && python3 run_page/gen_svg.py --from-db --type monthoflife --birth "${birth}" --special-color "#f9d367"  --special-color2 "#f0a1a8" --output assets/mol_walking.svg --use-localtime --athlete "$YOUR_NAME" --title "Walker Month of Life" --sport-type walking \
  && python3 run_page/gen_svg.py --from-db --type monthoflife --birth "${birth}" --special-color "#f9d367"  --special-color2 "#f0a1a8" --output assets/mol_hiking.svg --use-localtime --athlete "$YOUR_NAME" --title "Hiker Month of Life" --sport-type hiking \
  && python3 run_page/gen_svg.py --from-db --type monthoflife --birth "${birth}" --special-color "#f9d367"  --special-color2 "#f0a1a8" --output assets/mol_cycling.svg --use-localtime --athlete "$YOUR_NAME" --title "Cyclist Month of Life" --sport-type cycling \
  && python3 run_page/gen_svg.py --from-db --type monthoflife --birth "${birth}" --special-color "#f9d367"  --special-color2 "#f0a1a8" --output assets/mol_swimming.svg --use-localtime --athlete "$YOUR_NAME" --title "Swimmer Month of Life" --sport-type swimming \
  && python3 run_page/gen_svg.py --from-db --type monthoflife --birth "${birth}" --special-color "#f9d367"  --special-color2 "#f0a1a8" --output assets/mol_skiing.svg --use-localtime --athlete "$YOUR_NAME" --title "Skier Month of Life" --sport-type skiing 
